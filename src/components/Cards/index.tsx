        ...
        <div className={"relative"}>
            <div className="w-[273px] h-[136px] rounded-[10px] border border-grey-300 z-[99] bg-grey-0">
                <div className={"w-full flex flex-row"}>
                    <div className={"w-[50px] h-[105px] rounded-[10px]  bg-[#EEEFEB] flex justify-center  mt-[16px] ml-[15px]"}>
                    ...
                    <div className={"w-full flex-col flex"}>
                        <div className={"w-full flex flex-row"}>
                            <div className={"w-full flex flex-col mt-[20px] ml-[17px]"}>
                                <div className={`[font-family:'SF_Pro-Regular',Helvetica] text-[16px] text-grey-700`}>
                                    {medication}
                                </div>
                                <div className={`[font-family:'SF_Pro-Regular',Helvetica] text-[16px] text-grey-700`}>
                                    Dose: {dose}
